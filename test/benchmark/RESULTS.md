...
./build/benchmarks/render_bench     # stdout, plus test/benchmark/output/render_bench.{md,csv}
./build/benchmarks/reduction_bench  #         plus test/benchmark/output/reduction.{md,csv}
./build/benchmarks/cache_bench      #         plus test/benchmark/output/cache.{md,csv}
./build/benchmarks/model_bench      #         plus test/benchmark/output/models.{md,csv}
./build/benchmarks/occupancy_bench  #         plus test/benchmark/output/occupancy.{md,csv}
./build/benchmarks/bvh_bench        #         plus test/benchmark/output/bvh.{md,csv}
./build/benchmarks/instance_bench   #         plus test/benchmark/output/instance.{md,csv}
./build/benchmarks/tlas_bench       #         plus test/benchmark/output/tlas.{md,csv}
./build/benchmarks/material_bench   #         plus test/benchmark/output/material.{md,csv}
./build/benchmarks/cull_bench       #         plus test/benchmark/output/cull.{md,csv}
```
...
The scenes are code in `test/benchmark/src/render_bench.cpp`, and the routes it measures
...
./build/apps/raster_triangle <width> <height> <triangles>
```
