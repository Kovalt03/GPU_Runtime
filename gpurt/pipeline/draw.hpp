...
// would drift, and the figures in test/benchmark/RESULTS.md would stop describing
...
// Same frame either way — it is a cost question, and test/benchmark/RESULTS.md has
